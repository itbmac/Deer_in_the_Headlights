package tutorial 
{
	...
	public class BackgroundPrototype extends ProceduralObjectProtoype 
	{
		...
		public function BackgroundPrototype(graphic:Class, state:int=0, movementStyle:int=0, region:int=0, probability:Number=1, minY:int=0, yRange:int=0, scrollFactor:Number=0.0, scale:Number=1.0) 
		{
